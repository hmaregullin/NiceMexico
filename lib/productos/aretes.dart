      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            const Text(
                'Los postes son de Acero quirúrgico material con el cual están fabricadas las herramientas médicas que se usan en las cirugías (bisturí, pinzas tijeras) es una aleación de hierro y carbono, con la característica de ser hipoalergénico, esto significa que tiene una probabilidad muy baja de generar reacciones.',
                style: TextStyle(
                  fontSize: 18,
                ),
            ...
            SizedBox(
              ...
              child: ClipRRect(
                ...
                child: Image.asset('assets/images/arete.jpg'),
              ),
            ),
            const SizedBox(
              height: 20,
